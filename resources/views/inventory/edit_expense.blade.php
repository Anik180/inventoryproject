      ...
      <div class="row">
         ...
         <div class="col-md-8 offset-lg-2 shadow p-3 mb-5 bg-light rounded">
            ...
            <div class="card card-primary">
               ...
               <!-- /.card-header -->
               <!-- form start -->
            <form action="{{route('update.expense',$edit->id)}}" method="post" >
                  @csrf
                  <div class="card-body">
                     ...
                     <div class="row">
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" name="expens_amount" class="form-control" id="expens_amount" value="{{ $edit->expens_amount}}" required>
                        </div>
                           ...
                           <input type="text" name="expenses_detail" class="form-control" id="expenses_detail" value="{{ $edit->expenses_detail}}" required>
                        </div>
                    {{--     <div class="form-group col-md-6">
                           <label>Expense Detail</label>
                           
                           <textarea class="form-control" name="expenses_detail" value="{{ $edit->expenses_detail}}" id="expenses_detail"   required></textarea>
                        </div> --}}
                     </div>
                     <div class="row">
                        <div class="form-group col-md-6">
