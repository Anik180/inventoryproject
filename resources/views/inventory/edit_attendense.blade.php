...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Update Attendence</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
{{-- datatble --}}
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Update Attendence {{ $date->attendence_date }}</h3>
            ...
            <div class="card-body">
              <table {{-- id="example1" --}} class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <input type="radio" name="attendence[{{ $row->id }}]" value="Adsense" <?php if($row->attendence == 'Adsense'){
                    echo "checked";
                  } ?>>adsense
                  </td>
               ...
               <div class="card-footer">
                     <button type="submit" class="btn btn-success"  style="float: right;">Update Attendence</button>
                  </div>
                  </form>
            </div>
            <!-- /.card-body -->
