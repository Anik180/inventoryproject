      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="card card-primary">
               ...
               <!-- /.card-header -->
               <!-- form start -->
                      <form action="{{route('update.supplier',$edit->id)}}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                     <div class="row">
                     ...
                     <div class="row">
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" name="shop" class="form-control" id="shop" value="{{$edit->shop}}" required="">
                        </div>
                        <div class="form-group col-md-6">
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" name="branch_name" class="form-control" id="branch_name" value="{{$edit->branch_name}}"  required="">
                        </div>
                        <div class="form-group col-md-6">
